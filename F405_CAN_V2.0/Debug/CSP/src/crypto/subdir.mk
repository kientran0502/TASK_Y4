...
CSP/src/crypto/%.o CSP/src/crypto/%.su CSP/src/crypto/%.cyclo: ../CSP/src/crypto/%.c CSP/src/crypto/subdir.mk
...
clean: clean-CSP-2f-src-2f-crypto

clean-CSP-2f-src-2f-crypto:
	-$(RM) ./CSP/src/crypto/csp_hmac.cyclo ./CSP/src/crypto/csp_hmac.d ./CSP/src/crypto/csp_hmac.o ./CSP/src/crypto/csp_hmac.su ./CSP/src/crypto/csp_sha1.cyclo ./CSP/src/crypto/csp_sha1.d ./CSP/src/crypto/csp_sha1.o ./CSP/src/crypto/csp_sha1.su

.PHONY: clean-CSP-2f-src-2f-crypto
