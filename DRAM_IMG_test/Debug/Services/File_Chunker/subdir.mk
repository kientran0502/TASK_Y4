...
C_SRCS += \
../Services/File_Chunker/usb_receive.c 

OBJS += \
./Services/File_Chunker/usb_receive.o 

C_DEPS += \
./Services/File_Chunker/usb_receive.d 


# Each subdirectory must supply rules for building sources it contributes
Services/File_Chunker/%.o Services/File_Chunker/%.su Services/File_Chunker/%.cyclo: ../Services/File_Chunker/%.c Services/File_Chunker/subdir.mk
...
clean: clean-Services-2f-File_Chunker

clean-Services-2f-File_Chunker:
	-$(RM) ./Services/File_Chunker/usb_receive.cyclo ./Services/File_Chunker/usb_receive.d ./Services/File_Chunker/usb_receive.o ./Services/File_Chunker/usb_receive.su

.PHONY: clean-Services-2f-File_Chunker
