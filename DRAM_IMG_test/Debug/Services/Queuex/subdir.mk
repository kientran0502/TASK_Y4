...
C_SRCS += \
../Services/Queuex/queuex.c 

OBJS += \
./Services/Queuex/queuex.o 

C_DEPS += \
./Services/Queuex/queuex.d 


# Each subdirectory must supply rules for building sources it contributes
Services/Queuex/%.o Services/Queuex/%.su Services/Queuex/%.cyclo: ../Services/Queuex/%.c Services/Queuex/subdir.mk
...
clean: clean-Services-2f-Queuex

clean-Services-2f-Queuex:
	-$(RM) ./Services/Queuex/queuex.cyclo ./Services/Queuex/queuex.d ./Services/Queuex/queuex.o ./Services/Queuex/queuex.su

.PHONY: clean-Services-2f-Queuex
