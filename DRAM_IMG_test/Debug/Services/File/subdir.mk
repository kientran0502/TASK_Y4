...
C_SRCS += \
../Services/File/usb_receive.c 

OBJS += \
./Services/File/usb_receive.o 

C_DEPS += \
./Services/File/usb_receive.d 


# Each subdirectory must supply rules for building sources it contributes
Services/File/%.o Services/File/%.su Services/File/%.cyclo: ../Services/File/%.c Services/File/subdir.mk
...
clean: clean-Services-2f-File

clean-Services-2f-File:
	-$(RM) ./Services/File/usb_receive.cyclo ./Services/File/usb_receive.d ./Services/File/usb_receive.o ./Services/File/usb_receive.su

.PHONY: clean-Services-2f-File
